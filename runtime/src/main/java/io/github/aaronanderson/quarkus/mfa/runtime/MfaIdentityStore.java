...
public interface MfaIdentityStore {
	...
	public PasswordResetResult passwordReset(String username, PasswordCredential currentPassword, PasswordCredential newPassword, Map<String, Object> attributes);
	...
	public static enum AuthenticationResult {
		SUCCESS, SUCCESS_VERIFY_TOTP, SUCCESS_REGISTER_TOTP, SUCCESS_RESET_PASSWORD, FAILED, FAILED_ACCOUNT_LOCKED;
	}

	public static enum PasswordResetResult {
		SUCCESS, SUCCESS_VERIFY_TOTP, SUCCESS_REGISTER_TOTP, FAILED_CURRENT, FAILED_POLICY, FAILED_ACCOUNT_LOCKED;
	}

	public static enum VerificationResult {
		SUCCESS, FAILED, FAILED_ACCOUNT_LOCKED;
	}
}
